...
/**
 * The {@code DeckFactory} class is used to create and manage multiple decks of
 * cards.
 * <p>
 * This class provides functionality for creating and keeping track of multiple
 * {@link Deck} objects,
 * each of which can be shuffled, dealt from, and managed independently. The
 * factory allows you to
...
public class DeckFactory {
    ...
    /**
     * The `decks` member variable represents a collection of all the decks created
     * by the factory.
    ...
    /**
     * Constructor for the DeckFactory class that creates a specified number of
     * {@link Deck} objects.
     *
    ...
    /**
     * Creates a new deck of cards and adds it to the list of decks managed by the
     * factory.
     *
    ...
    /**
     * Gets a specific deck by its index in the list of decks managed by the
     * factory.
     *
     * @param index the index of the deck to get
     * @return the deck at the specified index, or {@code null} if the index is
     *         invalid
     */
     ...
     * @return {@code true} if the deck was successfully removed, {@code false}
     *         otherwise
     */
    ...
    /**
     * Shuffles a specific deck by its index in the list of decks managed by the
     * factory.
     *
     * @param index the index of the deck to shuffle
     * @return {@code true} if the deck was successfully shuffled, {@code false}
     *         otherwise
     */
