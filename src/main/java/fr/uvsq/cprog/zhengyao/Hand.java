 ...
 * This class provides methods to add or remove cards from the hand, as well as
 * to
 * obtain a list of the cards in the hand, get the size of the hand, sort the
 * cards,
...
public class Hand {
     ...
     *
     * @param cards the list of cards to include in this hand, must not be
     *              {@code null}
     ...
     * <p>
     * This method uses the Collections framework to sort the cards stored in the
     * `cards` list based on their natural ordering,
     ...
     * @return an {@link Optional} containing the found card, or an empty
     *         {@link Optional} if no such card was found
     */
    ...
    /**
     * Returns a string representation of this hand, listing the rank and suit of
     * each card in the hand.
     * The format of the returned string is "Hand: [Rank1 of Suit1], [Rank2 of
     * Suit2], ... [RankN of SuitN]".
     *
